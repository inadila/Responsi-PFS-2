                        ...
                        <tbody>
                          @forelse($products as $product)
                            <tr>
                                ...
                                <td>{{$product->main_ingredients}} {{$product->main_ingredients}}</td>
                                <td>{{$product->description_product}} {{$product->description_product}}</td>
                                <td>
