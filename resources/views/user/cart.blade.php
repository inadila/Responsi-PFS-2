                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="cart-action text-end">
                            ...
                            <a href="{{route('user.checkout')}}" class="btn"> <i class="fi-rs-box-alt mr-10"></i> Proceed to Checkout(Rp.{{$totalPrice}})</a>
                        </div>
                                        ...
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="cart_total_amount"><strong><span class="font-xl fw-900 text-brand">Rp.{{$totalPrice}}</span></strong></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
