...
<head>
    <meta charset="utf-8">
    <title>ID Beauty | Register</title>
                                        ...
                                        <form method="post" action="{{ route('register') }}">
                                            ...
                                            <div class="form-group">
                                                <button type="submit" 
                                                    ...
                                                    style="background-color: #e079c5; color: white; border: none;">
                                                    Submit &amp; Register
                                                </button>
                                            </div>
                                        </form>                                        
                                        <div class="buton">Already have an account? <a href="{{route('login')}}">Sign in now</a></div>
                                    </div>
                                </div>
                            </div>                            
                            <div class="col-lg-6">
                               <img src="user/assets/imgs/logo/app_logo1.png" alt="Logo">
                            </div>
                        </div>
                    </div>
                </div>
